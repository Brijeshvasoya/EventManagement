...
exports.sendTicketEmail = async (user, booking, event, pdfBuffer = null) => {
  try {
      ...
      html: `
        <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 600px; margin: auto; border: 1px solid #e2e8f0; border-radius: 16px; overflow: hidden;">
          <div style="background: linear-gradient(135deg, #1e1b4b 0%, #4338ca 100%); padding: 40px; color: white; textAlign: center;">
            ...
            <p style="opacity: 0.8;">Get ready for an amazing experience. We've attached your digital ticket to this email.</p>
          </div>
          <div style="padding: 30px; background: white;">
            ...
            <div style="margin-top: 30px; padding: 20px; background: #f8fafc; border-radius: 12px; textAlign: center;">
              <p style="margin: 0; font-size: 14px; color: #64748b;">Show the attached PDF ticket or your dashboard QR code at the venue entrance.</p>
            </div>
          </div>
    ...
    console.log(`✅ Ticket email (with PDF) sent to ${user.email}`);
  } catch (error) {
