...
exports.register = async ({ name, email, password, role }) => {
  ...
  return { token: signToken({ id: user.id, email: user.email, role: user.role, name: user.name, isPlanPurchased: user.isPlanPurchased, planId: user.planId, planExpiresAt: user.planExpiresAt }), user };
};
...
exports.login = async ({ email, password }) => {
  ...
  return { token: signToken({ id: user.id, email: user.email, role: user.role, name: user.name, createdAt: user.createdAt, isPlanPurchased: user.isPlanPurchased, planId: user.planId, planExpiresAt: user.planExpiresAt }), user };
};
